...
### Using ZMK Studio (Optional)

For real-time keymap editing without rebuilding firmware:

1. Download the `totem_studio_left-seeeduino_xiao_ble-zmk.uf2` from the firmware artifacts
2. Flash it to the **left half** only
3. Connect via USB and open [ZMK Studio](https://zmk.studio/)
